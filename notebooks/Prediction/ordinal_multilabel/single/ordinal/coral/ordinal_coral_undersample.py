...
result_dir = r"D:\fujiwara\M\result\ordinal_multilabel\single\ordinal\coral\5_undersample"
...
print("統合評価の保存フェーズ開始")
# ========= 統合評価CSVの出力（完全版） =========
summary_all_path = os.path.join(result_dir, "metrics_all_summary_coral_5_undersample.csv")
