...
result_dir = r"D:\fujiwara\M\result\binary+ordinal_multilabel\multi\lr+multitaskcoralNN"
...
print("統合評価の保存フェーズ開始")
# ========= 統合評価CSVの出力（完全版） =========
summary_all_path = os.path.join(result_dir, "metrics_all_summary_lr_multiNN.csv")
...
plt.tight_layout()
plt.savefig(os.path.join(result_dir, "confusion_matrix_binary_lr_multitaskcoralNN.png"))
plt.close()
...
plt.tight_layout()
plt.savefig(os.path.join(result_dir, "confusion_matrix_ordinal_lr_multitaskcoralNN.png"))
plt.close()
